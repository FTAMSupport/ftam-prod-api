...
// Function call to get transaction details
...
// authorize and charge credit card
router.post('/', function (req, res, next) {
  chargeCreditCard(function (data) {
...
router.post('/getTransactionDetails', function (req, res, next) {
  console.log(constants.apiLoginKey);
  getTransactionDetails('40008647523', function(data){      // skalapa
   //  getTransactionDetails('2259796597', function(data){  //SDK 
